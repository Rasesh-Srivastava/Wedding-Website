...
export const DEFAULT_EVENTS = [
  {
    ...
    venue: 'Poolside Lawn & Gardens',
    dressCode: 'Green & Floral Festive',
    description: 'An afternoon of henna, music, vibrant colors, and joyful celebrations.',
  ...
  },
  {
    id: 'haldi',
    date: 'DEC 3, 2026',
    fancyName: 'The Golden Glow',
    actualName: 'Haldi Ceremony',
    time: '10:00 AM Onwards',
    venue: 'Sunlit Courtyard',
    dressCode: 'Shades of Yellow',
    description: 'A sacred morning of turmeric, auspicious laughter, and warm blessings.',
  ...
  },
  {
    id: 'wedding',
    date: 'DEC 3, 2026',
    fancyName: 'Forever Begins',
    actualName: 'Wedding Ceremony',
    time: '4:00 PM Onwards',
    venue: 'Royal Lawn & Mandap',
